...
import com.ssafy.viewpagerproject.databinding.ActivityMarginVpBinding

class MarginVPActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMarginVpBinding
    private var list = mutableListOf(R.drawable.icon1, R.drawable.icon2, R.drawable.icon3, R.drawable.icon4)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMarginVpBinding.inflate(layoutInflater)
